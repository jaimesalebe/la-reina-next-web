    ...
    return (
        <>
            <article className="w-96">
                <Image src={singerImage} alt="" height={600} width={500} onClick={handleOpen} className="cursor-pointer rounded-md h-full w-full hover:scale-105 transition-all duration-500 " />
